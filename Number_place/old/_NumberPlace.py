...
class Cell_Matrix:
    ...
    def update_cell_value(self,cell,candidate=set()):
        ...
        #後処理
        print("row " +str(cell.row) +" Col "+str(cell.column) +" V:"+cell.value)
...
def recursive_calc_cell_matrix(cell_matrix,select_cell=None,candidate={}):
    ...
    while True:
        ...
        if cell_matrix.should_calculation_stopped():
            ...
            print('In should_calculation_stopped')
            print_answer(cell_matrix)   #debug用
            ...
            for i in backup_select_cell.candidate_set:
                recursive_calc_cell_matrix(cell_matrix,select_cell,{i})
                print("Return & Rollback 前")
                print_answer(cell_matrix)
                cell_matrix = backup_cell_matrix
                print("Return & Rollback 後")
                print_answer(cell_matrix)

        else:pass #print('更新あり')
